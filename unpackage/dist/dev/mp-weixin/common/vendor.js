...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  // 往当前歌单添加歌曲
  addPlaylistSong: function addPlaylistSong(state, payload) {
...

{
  ...
  // 获取歌曲详情
  getSongDetail: function getSongDetail(_ref4)
  ...
  {var getters = _ref4.getters;
    return new Promise( /*#__PURE__*/function () {var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(resolve, reject) {var res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  (0, _index.default)({
                    url: '/song/detail',
                    data: {
                      ids: getters.currentSong.id } }));case 2:res = _context2.sent;if (!(


                res.data.code !== 200)) {_context2.next = 6;break;}
                reject('获取歌曲失败！');return _context2.abrupt("return");case 6:


                resolve(res.data.songs[0]);case 7:case "end":return _context2.stop();}}}, _callee2);}));return function (_x3, _x4) {return _ref5.apply(this, arguments);};}());

  },
  // 获取歌词
  getLyric: function getLyric(_ref6)



  {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var state, getters, commit, lyric;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:state = _ref6.state, getters = _ref6.getters, commit = _ref6.commit;_context3.next = 3;return (

                (0, _index.default)({
                  url: '/lyric',
                  data: {
                    id: getters.currentSong.id } }));case 3:lyric = _context3.sent;
  ...
  // 解析歌词
  parseLyric: function parseLyric(_ref7,

  text) {var commit = _ref7.commit;
    var lyrics = [];
  ...
  // 监听用户 播放操作
  switchPlaySong: function switchPlaySong(_ref8)



  {var state = _ref8.state,commit = _ref8.commit,getters = _ref8.getters;
    // 如果没有链接
  ...
  // 监听用户 暂停操作
  switchPauseSong: function switchPauseSong(_ref9)


  {var state = _ref9.state,commit = _ref9.commit;
    state.BackgroundAudioManager.pause();
    commit('pause');
  },
  autoPlay: function autoPlay(_ref10)



  {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var commit, getters, state, _yield$_this2$dispatc, _yield$_this2$dispatc2, err, url;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:commit = _ref10.commit, getters = _ref10.getters, state = _ref10.state;_context4.next = 3;return (
                _this2.dispatch('getSongSrc').then(function (res) {return [null, res];}).catch(function (err) {return [err, null];}));case 3:_yield$_this2$dispatc = _context4.sent;_yield$_this2$dispatc2 = _slicedToArray(_yield$_this2$dispatc, 2);err = _yield$_this2$dispatc2[0];url = _yield$_this2$dispatc2[1];if (!

              err) {_context4.next = 11;break;}
              (0, _utils.showToast)({
                title: err });

              commit('next');return _context4.abrupt("return");case 11:


              // 如果没有封面
              if (!getters.currentSong.al) {
                _this2.dispatch('getSongDetail').then(function (res) {
              ...
              state.BackgroundAudioManager.title = getters.currentSong.name;
              commit('play');
              _this2.dispatch('getLyric');case 17:case "end":return _context4.stop();}}}, _callee4);}))();
  } };exports.default = _default;
